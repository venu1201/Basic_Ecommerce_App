...
const Footer = () => (
  <section className={`${styles.flexCenter} bg-discount-gradient p-3 m-2 rounded-2xl flex-col`}>
    <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
      <div className=" flex flex-row justify-center mr-16">
        ...
        />
        <div className="flex-1 font-poppins text-[30px] font-bold flex justify-center items-center text-gradient">
            Amazzz
        </div>
      </div>
    ...
    <div className="w-full p-5 flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
      <p className="font-poppins font-normal text-center text-[18px] leading-[27px] text-white">
        Copyright Ⓒ 2023 Amazzz. All Rights Reserved.
      </p>
